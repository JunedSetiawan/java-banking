...
class Customer extends User {
    ...
    public void openNewAccount() {
        ...
        if (amount < 1000)
            ...
            System.out.println("Okay! You have Rp. " + amount.toString() + " as opening balance");
    ...
    public void showFinancialSummary() {
        FinancialSummary.showFinancialSummary(this);
    }
}
...
class Bank {
    ...
    private Bank() {
        admin = new Admin("Juned Setiawan", "admin", "admin");
        admin.bank = this;
        bank = this;
        bankStarted = true;
...
public class App {
    public static void main(String[] args) throws IOException {
        System.out.println("===============================");
        System.out.println("Welcome to the Bank Jnd");
        System.out.println("===============================");
                        ...
                        if (cust == null) {
                            ...
                            do {
                                ...
                                if (input3 == 1) { // open account
                                    ...
                                    cust.showFinancialSummary(); // view financial summary
                                } else if (input3 != 0) {
    ...
    public static void showCustomerMenu() {
        ...
        System.out.println("Press 7 to show all my financial summary");
